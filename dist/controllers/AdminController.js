...
var CreateVendor = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, address, pincode, foodType, email, password, ownerName, phone, existingVandor, salt, userPassword, createdVendor;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, res.json({ message: "Vendors data is not available" })];
        }
    });
}); };
