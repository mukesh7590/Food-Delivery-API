...
var onRequestOTP = function (otp, toPhoneNumber) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                accountSid = "AC05330bd82d89dfa4d9196a23aef353b4";
                authToken = "102c640a865338c05991c867c2dc5405";
                client = require("twilio")(accountSid, authToken);
                return [4 /*yield*/, client.messages.create({
                        body: "Your OTP is ".concat(otp),
                        from: "+18159576423",
                        to: "+91".concat(toPhoneNumber), // recipient phone number // Add country before the number
                    })];
            case 1:
                response = _a.sent();
